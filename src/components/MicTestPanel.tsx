...
/**
 * Isolated Chrome mic check for localhost:3010 — no API / TTS needed.
  ...
  return (
    <div className="mx-auto max-w-lg space-y-4 rounded-2xl border border-[#e8dfd0] bg-white/90 p-5 text-center text-[#3f6339] shadow-md">
      ...
      <p className="text-base leading-relaxed">
        ...
        <strong>http://localhost:3010</strong> — niet in het Cursor-venster.
        Stop deze test vóór een gesprek met Fenna.
      </p>
